...
import com.spring.application.repository.CoursesRepository;
import com.spring.application.repository.EazyClassRepository;
...
public class AdminController {
    ...
    public ModelAndView addStudent(Model model, @ModelAttribute("person") Person person, HttpSession session) {
        ...
        Person person2=personRepository.findByEmail(person.getEmail());
